  ...
  React.useEffect(() => {
    ...
    fetch(
      "http://127.0.0.1:7435/ingest/573e11c3-4929-47fe-8a5b-0b9558470170",
      {
        ...
        body: JSON.stringify({
          sessionId: "021120",
          location: "app/(tabs)/dashboard/index.jsx:HRDashboardMount",
          message: "Dashboard screen mounted",
          hypothesisId: "H3_dashboardScreenMounted",
          data: { routeKey: "dashboard/index" },
          timestamp: Date.now(),
        }),
      },
    ).catch(() => {});
