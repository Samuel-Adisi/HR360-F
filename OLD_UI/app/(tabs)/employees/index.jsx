      ...
      <View style={mo.overlay}>
        <View style={mo.sheet}>
          ...
          <View style={mo.footer}>
            <TouchableOpacity
              style={mo.editBtn}
              onPress={() => router.replace(`/employees/${emp.id}`)}
            >
  ...
  useEffect(() => {
    ...
    fetch(
      "http://127.0.0.1:7435/ingest/573e11c3-4929-47fe-8a5b-0b9558470170",
      {
        ...
        body: JSON.stringify({
          sessionId: "021120",
          location: "app/(tabs)/employees/index.jsx:EmployeeScreenMount",
          message: "Employee screen mounted",
          hypothesisId: "H2_employeeScreenMounted",
          data: { routeKey: "employees" },
          timestamp: Date.now(),
        }),
      },
    ).catch(() => {});
