  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        <NativeTabs.Trigger name="leave" href={null} />
        <NativeTabs.Trigger name="payroll" href={null} />
        <NativeTabs.Trigger name="recruitment" href={null} />
        <NativeTabs.Trigger name="announcements" href={null} />
      </NativeTabs>
    </View>
  );
}
