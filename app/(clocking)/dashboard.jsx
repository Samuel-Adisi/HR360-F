  ...
  const menuItems = [
    {
      ...
      label: "Dashboard",
      hasSubmenu: true,
      submenu: ["Dashboard 1", "Dashboard 2"],
    },
    {
      id: "Employees",
      icon: "people-outline",
    ...
    },
    {
      ...
      label: "Projects",
      hasSubmenu: true,
      submenu: ["All-Projects", "Add-Project"],
    },
    {
      id: "Attendance",
    ...
    },
    {
      ...
      label: "Payroll",
      hasSubmenu: true,
      submenu: ["Employee Salary", "Payslip", "Payment"],
    },
    {
      id: "Job",
      icon: "briefcase-outline",
      label: "Job",
      hasSubmenu: true,
      submenu: ["User Dashboard", "Jobs Dashboard", "Applied Jobs"],
    },
    {
      id: "Consultancy",
      icon: "people-outline",
...

    {
      ...
      label: "Email",
      hasSubmenu: true,
      submenu: ["Inbox", "Compose", "Mail View"],
    },
    {
      id: "Chat",
